...
export const projects: Project[] = [
	...
	},
	{
		...
		tech: ['Angular', 'TypeScript', 'Fastify', 'Tailwind CSS', 'Docker', 'Steam API'],
	...
	},
	{
		...
		tech: ['Angular', 'TypeScript', 'Express', 'MySQL', 'Auth0', 'Docker', 'MinIO', 'Tailwind CSS'],
	...
	},
	{
		...
		origin: 'Personal project',
		summary: 'A desktop application that processes CSV files for payroll-related workflows.',
		challenge:
